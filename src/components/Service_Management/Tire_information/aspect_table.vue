<template>
  ...
  const items = ref([
  { Number: 1, Division: 'Brand', Brand: '35'}, 
  { Number: 2, Division: 'Brand', Brand: '40'}, 
  { Number: 3, Division: 'Brand', Brand: '45'}, 
  { Number: 4, Division: 'Brand', Brand: '50'}, 
  { Number: 5, Division: 'Brand', Brand: '50'}, 
  { Number: 6, Division: 'Brand', Brand: '60'}, 
  { Number: 7, Division: 'Brand', Brand: '70'}, 
  { Number: 8, Division: 'Brand', Brand: '80'}, 
  { Number: 9, Division: 'Brand', Brand: '75'}, 
  { Number: 10, Division: 'Brand', Brand: '65'}, 
]);
