<template>
  ...
  const items = ref([
  { Number: 1, Division: 'Brand', Brand: '22'}, 
  { Number: 2, Division: 'Brand', Brand: '21'}, 
  { Number: 3, Division: 'Brand', Brand: '20'}, 
  { Number: 4, Division: 'Brand', Brand: '19'}, 
  { Number: 5, Division: 'Brand', Brand: '18'}, 
  { Number: 6, Division: 'Brand', Brand: '17'}, 
  { Number: 7, Division: 'Brand', Brand: '16'}, 
  { Number: 8, Division: 'Brand', Brand: '15'}, 
  { Number: 9, Division: 'Brand', Brand: '14'}, 
  { Number: 10, Division: 'Brand', Brand: '13'}, 
]);
