            ...
            <v-col cols="6">
              <v-row>
                ...
                <input
                  ...
                  v-model="status"
                />
                <label for="Approved" class="radio-label">승인완료</label>
                <input
                  type="radio"
                  id="denied"
                  name="hidden"
            ...
            <v-col cols="6">
              <v-row>
                ...
                <input
                  ...
                  v-model="status"
                />
                <label for="entire2" class="radio-label">전체</label>
                <input
                  type="radio"
                  id="Waiting"
                  name="entire2_name"
                  ...
                  v-model="status"
                />
                <label for="Waiting" class="radio-label">답변대기</label>
                <input
                  type="radio"
                  id="Answer"
                  name="entire2_name"
                  ...
                  v-model="status"
                />
                <label for="Answer" class="radio-label">답변완료</label>
              </v-row>
            </v-col>
          </v-row>
          <v-row>
